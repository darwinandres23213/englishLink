...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('img/EL3.png')); ?>">
...
<body>
    ...
    <div class="login-bg-slider">
        <div class="login-bg-slide active" style="background-image: url('<?php echo e(asset('img/EL_fotor.jpg')); ?>')">
            <div class="login-bg-overlay"></div>
        </div>
        <!-- <div class="login-bg-slide" style="background-image: url('<?php echo e(asset('img/Wow.jpg')); ?>')">
            <div class="login-bg-overlay"></div>
        </div>
        <div class="login-bg-slide" style="background-image: url('<?php echo e(asset('img/Img2.jpg')); ?>')">
            <div class="login-bg-overlay"></div>
        </div>
        <div class="login-bg-slide" style="background-image: url('<?php echo e(asset('img/Img3.jpg')); ?>')">
            <div class="login-bg-overlay"></div>
        </div>
        <div class="login-bg-slide" style="background-image: url('<?php echo e(asset('img/Img4.jpg')); ?>')">
            <div class="login-bg-overlay"></div>
        </div> -->
    </div>
    ...
    <header class="header">
        <nav class="navbar">
            ...
            <ul class="nav-menu">
                ...
                <li><a href="<?php echo e(route('public.about')); ?>" class="nav-link">Nosotros</a></li>
                <li><a href="<?php echo e(route('public.courses')); ?>" class="nav-link">Cursos</a></li>
                <li><a href="<?php echo e(route('public.contact')); ?>" class="nav-link">Contacto</a></li>
                <li><a href="<?php echo e(route('login')); ?>" class="nav-link login-btn active">Ingresar</a></li>
            </ul>
            <div class="hamburger">
                <span></span>
                <span></span>
