<?php $__env->startSection('title', 'EnglishLink - Aprende Inglés'); ?>
<?php $__env->startSection('description', 'Domina el inglés con nuestros cursos personalizados, profesores nativos y metodología innovadora. Tu futuro comienza aquí.'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="hero">
        <div class="hero-slider">
            <div class="slide active" style="background-image: url('<?php echo e(asset('img/Wow.jpg')); ?>')">
                <div class="slide-overlay"></div>
            </div>
            <div class="slide" style="background-image: url('<?php echo e(asset('img/Img2.jpg')); ?>')">
                <div class="slide-overlay"></div>
            </div>
            <div class="slide" style="background-image: url('<?php echo e(asset('img/Img3.jpg')); ?>')">
                <div class="slide-overlay"></div>
            </div>
            <div class="slide" style="background-image: url('<?php echo e(asset('img/Img4.jpg')); ?>')">
                <div class="slide-overlay"></div>
            </div>
        ...
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                <a href="<?php echo e(route('public.courses')); ?>" class="btn btn-primary">Ver Cursos</a>
                <a href="<?php echo e(route('public.contact')); ?>" class="btn btn-secondary">Contáctanos</a>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="courses-slider">
                <div class="course-card">
                    <img src="<?php echo e(asset('img/Img2.jpg')); ?>" alt="Curso Básico">
                ...
                <div class="course-card">
                    <img src="<?php echo e(asset('img/Img3.jpg')); ?>" alt="Curso Intermedio">
                    <div class="course-content">
                ...
                <div class="course-card">
                    <img src="<?php echo e(asset('img/Img4.jpg')); ?>" alt="Curso Avanzado">
                    <div class="course-content">
            ...
            <div class="text-center mt-4">
                <a href="<?php echo e(route('public.courses')); ?>" class="btn btn-primary">Ver Todos los Cursos</a>
            </div>
        </div>
    </section>
            ...
            <div class="testimonials-grid">
                <div class="testimonial-card">
                    ...
                    <div class="testimonial-author">
                        <img src="<?php echo e(asset('img/Img5.jpg')); ?>" alt="María González">
                        <div>
                ...
                <div class="testimonial-card">
                    ...
                    <div class="testimonial-author">
                        <img src="<?php echo e(asset('img/Img6.jpg')); ?>" alt="Carlos Rodríguez">
                        <div>
    ...
    <section class="cta">
        <div class="container">
            ...
            <a href="<?php echo e(route('public.contact')); ?>" class="btn btn-primary btn-large">Empezar Ahora</a>
        </div>
    </section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.AreaPublica.appPagepublic', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\Documents\EnglishLink_Project\resources\views/public/welcome.blade.php ENDPATH**/ ?>